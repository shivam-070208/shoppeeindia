...
const ProductCard: React.FC<Props> = ({ deal, onDelete, deleteLoading }) => {
  return (
    <Card
      className={cn(
        "border-border bg-background relative flex min-h-[430px] flex-col justify-between overflow-hidden border pt-0 shadow transition-shadow",
      )}
    >
      <CardHeader className="p-0">
        ...
        <div className="border-border bg-background relative aspect-4/3 w-full">
          {deal.imageUrl && (
            <Image
              src={deal.imageUrl}
        ...
        <div className="mt-4 flex w-full items-center justify-between gap-2">
          ...
          <Button
            ...
            className={cn(
              ...
              "border-destructive text-destructive hover:bg-destructive/10 border transition-colors",
            )}
